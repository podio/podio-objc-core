...
extern NSString * const PKCClientAuthenticationStateDidChangeNotification;

@class PKCOAuth2Token;
@protocol PKCTokenStore;

@interface PKCClient : NSObject
 ...
 */
@property (nonatomic, strong, readonly) PKCHTTPClient *HTTPClient;

/**
 *  The current OAuth2 token used by the client. When not nil, the client is considered to be authenticated.
 */
@property (nonatomic, strong, readwrite) PKCOAuth2Token *oauthToken;
 ...
 */
@property (nonatomic, strong) id<PKCTokenStore> tokenStore;
