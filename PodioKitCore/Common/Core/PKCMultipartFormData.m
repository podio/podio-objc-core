...
@interface PKCMultipartFormData ()
...
@implementation PKCMultipartFormData
...
- (void)appendFormDataParameters:(NSDictionary *)parameters {
  NSDictionary *queryParameters = [parameters pkc_queryParametersPairs];
