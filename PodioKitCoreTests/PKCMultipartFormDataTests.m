...
@interface PKCMultipartFormDataTests : XCTestCase

@end

@implementation PKCMultipartFormDataTests

- (void)testGeneratesNonDataForBinary {
  PKCMultipartFormData *multiPartData = [PKCMultipartFormData multipartFormDataWithBoundary:kBoundary encoding:NSUTF8StringEncoding];
